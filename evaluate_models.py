...
def load_model(model_path,input_shape):
    model = srcnn.SRCNN() # initialize your model
...
undersampled_path = "datasets\\knee_multicoil_undersampled_x8"

train_set = dataloader.MRIDataset(undersampled_path)

train_loader = torch.utils.data.DataLoader(train_set,batch_size=1)
model_path = "checkpoints\\ALL_MODELS\\SRCNN_best_model_x8.pt"
model_name = "SRCNN_x8"
