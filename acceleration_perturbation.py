...
save_root = "Images\\file1000021\\perturbations\\acceleration_results"
...
save_root = "Images\\file1000021\\perturbations\\dl_acceleration_results"

# ---------------------------------------
# Existing Undersampled Datasets
# ---------------------------------------

acceleration_datasets = {
    "4x": "datasets\\sample_x4",
    "8x": "datasets\\sample_x8",
    "12x": "datasets\\sample_x12"
}
...
for acc_name, dataset_root in acceleration_datasets.items():
    ...
    sample_path = "datasets\\sample_temp"
    ...
    test_set = dataloader.MRIDataset(
        sample_path
    )
