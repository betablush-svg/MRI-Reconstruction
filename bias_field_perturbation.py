...
save_root = "Images\\file1000021\\perturbations\\bias_field_results"
...
def apply_bias_field(img, strength):
...
# ---------------------------------------
# Iterate Over Bias Levels
# ---------------------------------------

for bias_name, bias_strength in bias_levels.items():

    print(f"\nApplying Bias Field: {bias_name}")
    ...
    for name, model in models.items():
        ...
        with torch.no_grad():
            ...
            for sample in test_loader:
                ...
                # -----------------------------------
                # Apply Bias Field in Image Domain
                # -----------------------------------
                ...
                biased_np = apply_bias_field(
                    input_np,
                    bias_strength
                )

                # Convert back to tensor
                biased_input = torch.tensor(
                    biased_np,
